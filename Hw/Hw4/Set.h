...
template <class ItemType>
inline typename Set<ItemType>::Node* Set<ItemType>::findFirstAtMost(const ItemType& value) const
{
...
template <class ItemType>
inline void difference(const Set<ItemType>& s1, const Set<ItemType>& s2, Set<ItemType>& result)
{
